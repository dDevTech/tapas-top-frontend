...
import { Button, Alert, Row, Col, Breadcrumb, BreadcrumbItem } from 'reactstrap';
      ...
      <Row>
        <Col md="4" className="shadow-box">
          <Row>
            ...
            <Col>
              <p>nombre: david</p>
              <p>apellido: pefasdf</p>
              <p>edad: dfadsfavid</p>
              <p>correo: dafasdfvid</p>
            </Col>
          </Row>
          <Row>
            <p>hola: dfadsfavid</p>
